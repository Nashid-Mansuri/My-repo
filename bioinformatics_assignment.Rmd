...
if (length(k3_cbar) == 0 || length(k4_cbar) == 0 || length(k5_cbar) == 0) {
  ...
  barplot(as.numeric(top_under_cbar3), names.arg=names(top_under_cbar3), las=2, 
          main="C. baratii Under-rep 3-mers", xlab="K-mer", ylab="Count", col="blue", ylim=c(0, 1))
  ...
  barplot(as.numeric(top_under_cbar4), names.arg=names(top_under_cbar4), las=2, 
          main="C. baratii Under-rep 4-mers", xlab="K-mer", ylab="Count", col="blue", ylim=c(0, 1))
  ...
  barplot(as.numeric(top_under_cbar5), names.arg=names(top_under_cbar5), las=2, 
          main="C. baratii Under-rep 5-mers", xlab="K-mer", ylab="Count", col="blue", ylim=c(0, 1))
  ...
  par(mfrow=c(2, 1))
  over_counts3 <- matrix(c(as.numeric(top_over_cbar3), k3_ecoli[names(top_over_cbar3)]), 
                        nrow=10, ncol=2, dimnames=list(names(top_over_cbar3), c("C. baratii", "E. coli")))
  under_counts3 <- matrix(c(as.numeric(top_under_cbar3), k3_ecoli[names(top_under_cbar3)]), 
                         nrow=10, ncol=2, dimnames=list(names(top_under_cbar3), c("C. baratii", "E. coli")))
  over_counts3[is.na(over_counts3)] <- 0
  under_counts3[is.na(under_counts3)] <- 0
